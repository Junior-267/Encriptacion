...
<head>
  ...
  <style>
      ...
      .error { color: #c53030 ; background: #fff5f5 ; padding: 10px; border-radius: 4px; }
       comparacion { margin: 20px 0; padding: 15px; border-left: 4px solid #4299 e1; background: #ebf8ff ; }
    </style>
</head>
  <body>
    <div class="container" style="max-width: 800 px;">
      <div class="card">
        ...
        <div class="comparacion">
          ...
          <div class="exito">FIRMA VÁLIDA: El payload no ha sidoalterado </div>
          <?php else: ?>
              <div class="error">FIRMA INVÁLIDA: El payload ha sido modificado </div>
          <?php endif; ?>
        </div>
        ...
        <div class="comparacion">
          ...
          <?php if (hash_equals($firma_original , $firma_modificada)): ?>
            <div class="exito">FIRMA VÁLIDA: El payload no ha sidoalterado </div>
          <?php else: ?>
            <div class="error">FIRMA INVÁLIDA: ¡El payload ha sidomodificado!</div>
          <?php endif; ?>
        </div>
